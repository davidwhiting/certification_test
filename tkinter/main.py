...
class App(object):
    def __init__(self, window,ip,user,pswd,db):
        ...
        window.wm_title("Certification Database Interface")
...
#        self.current_row += 1     
    ...
    def sendQuery(self):
        ...
        self.query = "SELECT min(id), select_group FROM question_templates GROUP BY select_group"
